...
.reviewCard {
  ...
  /* Deeper shadow for added depth */
  padding: 20px;
  margin-bottom: 20px;
  transition: transform 0.3s ease-in-out;
  /* Smoother scaling effect */
  border: 2px solid #d4af37;
  /* Gold border to enhance the medieval feel */
  font-family: 'Cinzel', serif;
  /* Medieval-inspired font */
  display: flex;
...
.reviewCardContent {
  ...
  flex-direction: column;
  align-items: center;
  /* Center all content except for the date and username */
}
...
.gameTitle {
  ...
  color: #3e2a1e;
  /* Dark brown color for the title */
  font-weight: bold;
  text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.2);
  /* Light shadow for a dramatic effect */
}
...
.date {
  font-size: 0.9rem;
  color: #6a4c3a;
  /* Slightly lighter brown color for dates */
  text-align: right;
